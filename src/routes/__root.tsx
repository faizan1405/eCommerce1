...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Enter the futuristic fashion dimension. Curated, iconic, limited thrift streetwear." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Thrift Hauz" },
      { name: "twitter:description", content: "Immersive WebGL fashion universe." },
    ],
    links: [
